...
//        }
    ...
    public ArrayList<HomeApplianceElement> makeKitchenList(ArrayList<HomeApplianceElement> appliances){
        Main.LOGGER.info("Find appliances in kitchen...");
        for (HomeApplianceElement it : appliances) {
            if(it instanceof Kitchen){
                kitchen.add(it);
            }
    ...
    public void execute() {
        findAppliance.FindInRange(makeKitchenList(appliances));
    }
}
